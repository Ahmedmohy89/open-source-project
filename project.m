...
if task == 1
    FID = fopen('myfile.txt', 'r');    %opening text file, integer file identifier obtained in fid
...
x=imread('camera1.png');   %reading the image file into x matrix which contains binary values 
...
y=imread('camera.png');   %reading non-encrypted image
